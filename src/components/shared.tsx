...
export const Instagram = ({ className = "h-5 w-5" }: IconProps) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0Zm0 1.77c5.64 0 10.23 4.59 10.23 10.23S17.64 22.23 12 22.23 1.77 17.64 1.77 12 6.36 1.77 12 1.77Zm0 1.92a6.31 6.31 0 1 0 0 12.62 6.31 6.31 0 0 0 0-12.62Zm0 10.4a4.09 4.09 0 1 1 0-8.18 4.09 4.09 0 0 1 0 8.18Zm6.49-10.66a1.48 1.48 0 1 0 0-2.96 1.48 1.48 0 0 0 0 2.96Z" />
  </svg>
);
